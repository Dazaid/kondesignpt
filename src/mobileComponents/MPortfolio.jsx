    ...
    <>
      ...
      <Box ref={socialRef} className="text-white flex flex-col gap-7 justify-center text-center items-center text-2xl w-[100vw] konradialgradient3 py-16">
        ...
        <Box className="flex flex-row gap-6">
          <a target="_blank" aria-label="Instagram" href="https://www.instagram.com/kon_design_/"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
          ...
          <a target="_blank" aria-label="Facebook" href="https://www.facebook.com/kondesignpt"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
          ...
          <a target="_blank" aria-label="Whatsapp" href="https://wa.me/351913916397"><Box className="bg-white h-12 w-12 rounded-full flex justify-center items-center">
