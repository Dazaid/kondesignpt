  ...
  return (
    <>
      <Box ref={homeRef} className="flex justify-center items-center bg-cover h-[100vh] w-[100vw]">
        <svg className='absolute w-[90vw] h-[100vh] z-[-1]' version="1.0" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 318.000000 737.000000" preserveAspectRatio="xMidYMid meet">
...
209 28 225 31 38 8 109 44 154 78 l35 26 -1150 -1 -1149 0 -152 -53z" className="fill-[#fabf33] drop-shadow-[0_30px_20px_rgba(250,191,51,1)]"></path>
          </g>
        </svg>

        <Box className="flex flex-row text-white h-[51vh] gap-24">
          <Box className="flex flex-col gap-24">
            <img loading='lazy' className='w-20' src="assets/Logo.webp" alt="logo" />
            <Box>
              <Typography component={"h1"} variant="h1" sx={{ fontSize: "2rem" }} >

                <strong className='font-bold'>Design</strong>  para <br />
                empresas que <br />
                <b className='font-bold'> fazem a diferença!</b>
              </Typography>
              <Box className="mb-2 bg-gradient-to-r from-[#090310] from-10% via-[#6d2f95] via-50% to-[#fbba07] to-90% w-[19.5rem] h-[0.65vh] mt-2"></Box>
              <Typography component={"h2"} variant="h2" sx={{ fontSize: "2rem" }} ><strong className='text-[#a700ff] text-xl font-bold'>Branding, Web & Print.</strong></Typography>
            </Box>
          ...
          <Box className="h-[100%] flex flex-col justify-center items-center">
            <img loading='lazy' src="assets/PhotoPrinter.webp" alt="Photo Printer" />
          </Box>
